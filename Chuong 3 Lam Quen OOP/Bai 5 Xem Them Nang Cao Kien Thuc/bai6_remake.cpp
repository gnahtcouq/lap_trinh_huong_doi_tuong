...
void xuatDanhSachLop(SinhVien *arr, int n) {
  ...
  cout << setw(30) << right << "Ngay Sinh" << "\t" << endl;
  for (int i = 0; i < n; i++) {
    arr[i].xuat();
  }
}
...
int main() {
  ...
  if (mang.size() == 1) {
    cout << "\nSinh vien co diem thi chuyen nganh cao nhat lop" << endl;
    cout << setw(10) << left << "MSSV" << "\t";
    cout << setw(30) << left << "Ho Ten" << "\t";
    cout << setw(10) << left << "Lop" << "\t";
    cout << setw(15) << left << "CMND" << "\t";
    ...
    // xuat ra
    cout << "\nDanh sach sinh vien co diem thi chuyen nganh cao nhat lop bang nhau duoc sap xep theo thu tu tang dan cua ten" << endl;
    cout << setw(10) << left << "MSSV" << "\t";
    cout << setw(30) << left << "Ho Ten" << "\t";
    cout << setw(10) << left << "Lop" << "\t";
    cout << setw(15) << left << "CMND" << "\t";
